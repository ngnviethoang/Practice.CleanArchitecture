...
using MiniStore.Contract.CircuitBreakers;
using MiniStore.Contract.Datetimes;

namespace MiniStore.Persistence.CircuitBreakers;
...
public class CircuitBreakerManager : ICircuitBreakerManager, IDisposable
{
    ...
    public CircuitBreakerManager(IDbContextFactory<MiniStoreDbContext> dbContextFactory, IDateTimeProvider dateTimeProvider)
    {
