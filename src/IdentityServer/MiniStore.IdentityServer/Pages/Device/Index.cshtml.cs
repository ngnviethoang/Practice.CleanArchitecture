...
using MiniStore.IdentityServer.Pages.Consent;
...
public class Index : PageModel
{
    ...
    {
        DeviceFlowAuthorizationRequest? request = await _interaction.GetAuthorizationContextAsync(Input.UserCode ?? throw new ArgumentNullException(nameof(Input.UserCode)), ct);
        if (request == null)
        {
    ...
    {
        DeviceFlowAuthorizationRequest? request = await _interaction.GetAuthorizationContextAsync(userCode, ct);
        if (request != null)
        {
