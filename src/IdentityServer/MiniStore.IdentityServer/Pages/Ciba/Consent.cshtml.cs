...
public class Consent : PageModel
{
    ...
    public async Task<IActionResult> OnPostAsync(CancellationToken ct)
    {
        ...
        BackchannelUserLoginRequest? request = await _interaction.GetLoginRequestByInternalIdAsync(Input.Id ?? throw new ArgumentNullException(nameof(Input.Id)), ct);
    ...
    private async Task<bool> SetViewModelAsync(string? id, CancellationToken ct)
    {
        ...
        BackchannelUserLoginRequest? request = await _interaction.GetLoginRequestByInternalIdAsync(id, ct);
        if (request != null && request.Subject.GetSubjectId() == User.GetSubjectId())
        {
